...
DEMO_USERS = [
    {
        ...
        "username": "asha.m",
        "password": "Secure@123",
        "email": "asha.mehta@bankdemo.local",
        "phone": "+1-312-555-9084",
        "home_city": "Chicago",
        "status": "active",
        "failed_attempts": 0,
        "trusted_devices": ["ashas-iphone", "office-macbook"],
    ...
    },
    {
        ...
        "username": "ravi.k",
        "password": "Bank@789",
        "email": "ravi.kumar@bankdemo.local",
        "phone": "+1-214-555-7714",
        "home_city": "Dallas",
        "status": "locked",
        "failed_attempts": 4,
        "trusted_devices": ["ravi-thinkpad"],
        "requires_password_reset": 0,
    },
    {
        ...
        "username": "priya.n",
        "password": "Reset@456",
        "email": "priya.nair@bankdemo.local",
        "phone": "+1-408-555-2219",
        "home_city": "San Jose",
        "status": "active",
        "failed_attempts": 0,
        "trusted_devices": ["priya-pixel", "home-ipad"],
        "requires_password_reset": 0,
    },
    {
        ...
        "username": "daniel.l",
        "password": "Vault#321",
        "email": "daniel.lee@bankdemo.local",
        "phone": "+1-917-555-4432",
        "home_city": "New York",
        "status": "restricted",
        "failed_attempts": 1,
        "trusted_devices": ["daniel-surface"],
...
class BankingRepository:
    ...
    def _seed_demo_data(self, conn: sqlite3.Connection) -> None:
        ...
        trusted_event = self._create_login_event(
            conn,
            user_id=user_ids["asha.m"],
            attempted_username="asha.m",
            device_id="ashas-iphone",
            location="Chicago",
            outcome="allowed",
            risk_level="low",
        ...
        self._create_login_event(
            conn,
            user_id=user_ids["ravi.k"],
            attempted_username="ravi.k",
        ...
        suspicious_event = self._create_login_event(
            conn,
            user_id=user_ids["daniel.l"],
            attempted_username="daniel.l",
